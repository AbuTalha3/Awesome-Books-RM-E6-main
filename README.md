...
I have added the linters or tests in order to avoid any kind of typos and ensure the good practices in this project. So while using this repository if you need to check your work in **`Hyper Text Markup Language`** and **`CSS`** you can use the below commands
